...
class VmapWrapper(Wrapper[State]):
    ...
    def __init__(self, env: Environment, num_envs: Optional[int] = None, vectorize_over_env_params: bool = False):
        """
        ...
        Args:
            ...
            vectorize_over_env_params: If True, the reset and step methods will be vectorized over the environment parameters.
                This is useful for environments that support domain randomization.
        """
        super().__init__(env)
        ...
        self._vmap_step = jax.vmap(
            self._env.step,
            in_axes=(0, 0, env_params_in_axes),  # vmap over states and actions, and maybe env_params
            out_axes=(0, 0)
        )
